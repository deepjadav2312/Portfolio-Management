...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(options => {
        options.SwaggerEndpoint("/swagger/v1/swagger.json", "PortfolioManagement_APIV1");
        options.SwaggerEndpoint("/swagger/v2/swagger.json", "PortfolioManagement_APIV2");
    });
}
