...
{
    /// <inheritdoc />
    public partial class addtoallmodels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Budgent = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectDetailses", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectXTechnologies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProjectXTechnologies_ProjectDetailses_ProjectDetailsId",
                        column: x => x.ProjectDetailsId,
                        principalTable: "ProjectDetailses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectXTechnologies_Technologies_TechnologyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectXTechnologies_ProjectDetailsId",
                table: "ProjectXTechnologies",
                column: "ProjectDetailsId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectXTechnologies_TechnologyId",
                table: "ProjectXTechnologies",
                column: "TechnologyId");
